...
- idempotent: add [`Header(*http.Request) string`](https://godoc.org/github.com/orderlyvirtue/base/idempotent#Header) and `HeaderKey`
...
- admin: [`Server.AddHandler`](https://godoc.org/github.com/orderlyvirtue/base/admin#Server.AddHandler) for extendable commands
...
- k8s: Add [`Inside()`](https://godoc.org/github.com/orderlyvirtue/base/k8s#Inside) for cluster awareness.
- docker: Add [`Enabled()`](https://godoc.org/github.com/orderlyvirtue/base/docker#Enabled) for compatability checks.
...
- Add ParseError and ErrorList. (See: [moov-io/base #23](https://github.com/orderlyvirtue/base/issues/23))
